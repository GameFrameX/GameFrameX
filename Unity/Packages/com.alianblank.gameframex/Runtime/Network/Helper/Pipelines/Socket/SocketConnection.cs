...
namespace GameFrameX.Network.Pipelines
{
    public sealed class SocketConnection : ConnectionContext
    {
        ...
        public SocketConnection(System.Net.Sockets.AddressFamily family, string host, int port)
        {
        ...
        private async Task ExecuteAsync()
        {
            ...
            finally
            {
                ...
                await _application.Input.CompleteAsync(sendError);
            }
        }
