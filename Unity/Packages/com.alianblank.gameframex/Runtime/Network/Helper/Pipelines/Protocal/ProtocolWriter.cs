...
namespace GameFrameX.Network.Pipelines.Protocols
{
    ...
    public class ProtocolWriter //: IAsyncDisposable
    {
        ...
        public async ValueTask WriteAsync<TMessage>(IProtoCalWriteHelper<TMessage> protoCal, TMessage protocolMessage, CancellationToken cancellationToken = default)
        {
