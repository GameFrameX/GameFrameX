...
namespace GameFrameX.Runtime
{
    public class NetworkChannelHelper : INetworkChannelHelper
    {
        ...
        public void Initialize(INetworkChannel networkChannel)
        {
            ...
            GameApp.Event.Subscribe(NetworkMissHeartBeatEventArgs.EventId, OnNetworkMissHeartBeat);
            GameApp.Event.Subscribe(NetworkErrorEventArgs.EventId, OnNetworkError);
            GameApp.Event.Subscribe(NetworkCustomErrorEventArgs.EventId, OnNetworkCustomError);
        }
        ...
        {
            GameApp.Event.Unsubscribe(NetworkConnectedEventArgs.EventId, OnNetworkConnected);
            GameApp.Event.Unsubscribe(NetworkClosedEventArgs.EventId, OnNetworkClosed);
            GameApp.Event.Unsubscribe(NetworkMissHeartBeatEventArgs.EventId, OnNetworkMissHeartBeat);
            GameApp.Event.Unsubscribe(NetworkErrorEventArgs.EventId, OnNetworkError);
            GameApp.Event.Unsubscribe(NetworkCustomErrorEventArgs.EventId, OnNetworkCustomError);
