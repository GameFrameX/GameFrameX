...
namespace GameFrameX.Runtime
{
    ...
    public sealed class ResourceUpdateStartEventArgs : GameEventArgs
    {
        ...
        /// 资源更新开始事件编号。
        /// </summary>
        public static readonly string EventId = typeof(ResourceUpdateStartEventArgs).FullName;
        ...
        public static ResourceUpdateStartEventArgs Create(GameFrameX.Resource.ResourceUpdateStartEventArgs e)
        {
