...
namespace GameFrameX.Runtime
{
    ...
    public sealed class ResourceApplyStartEventArgs : GameEventArgs
    {
        ...
        /// 资源应用开始事件编号。
        /// </summary>
        public static readonly string EventId = typeof(ResourceApplyStartEventArgs).FullName;
        ...
        public static ResourceApplyStartEventArgs Create(GameFrameX.Resource.ResourceApplyStartEventArgs e)
        {
