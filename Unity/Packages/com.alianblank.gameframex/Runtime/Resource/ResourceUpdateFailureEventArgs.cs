...
namespace GameFrameX.Runtime
{
    ...
    public sealed class ResourceUpdateFailureEventArgs : GameEventArgs
    {
        ...
        /// 资源更新失败事件编号。
        /// </summary>
        public static readonly string EventId = typeof(ResourceUpdateFailureEventArgs).FullName;
        ...
        public static ResourceUpdateFailureEventArgs Create(GameFrameX.Resource.ResourceUpdateFailureEventArgs e)
        {
