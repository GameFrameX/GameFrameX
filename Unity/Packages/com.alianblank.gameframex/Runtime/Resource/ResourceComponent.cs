...
namespace GameFrameX.Runtime
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        [SerializeField] private ResourceMode m_ResourceMode = ResourceMode.Package;
        ...
        [SerializeField] private float m_ResourceAutoReleaseInterval = 60f;

        [SerializeField] private int m_ResourceCapacity = 16;

        [SerializeField] private float m_ResourceExpireTime = 60f;

        [SerializeField] private int m_ResourcePriority = 0;

        [SerializeField] private string m_UpdatePrefixUri = null;

        [SerializeField] private int m_GenerateReadWriteVersionListLength = OneMegaBytes;

        [SerializeField] private int m_UpdateRetryCount = 3;
        ...
        [SerializeField] private string m_LoadResourceAgentHelperTypeName =
            "UnityGameFramework.Runtime.DefaultLoadResourceAgentHelper";

        [SerializeField] private LoadResourceAgentHelperBase m_CustomLoadResourceAgentHelper = null;

        [SerializeField] private int m_LoadResourceAgentHelperCount = 3;
        ...
        {
            get { return m_ResourceManager.ResourceMode; }
        }
        ...
        {
            get { return m_ResourceManager.PackageVersionListSerializer; }
        }
        ...
        {
            get { return m_ResourceManager.UpdatableVersionListSerializer; }
        }
        ...
        {
            get { return m_ResourceManager.ReadOnlyVersionListSerializer; }
        }
        ...
        {
            get { return m_ResourceManager.ReadWriteVersionListSerializer; }
        }
        ...
        {
            get { return m_ResourceManager.ResourcePackVersionListSerializer; }
        }
        ...
        {
            get { return m_ResourceManager.ResourceGroupCount; }
        }
        ...
        {
            get { return m_ResourceManager.UpdatePrefixUri; }
            set { m_ResourceManager.UpdatePrefixUri = m_UpdatePrefixUri = value; }
        }
        ...
        {
            get { return m_ResourceManager.GenerateReadWriteVersionListLength; }
            set { m_ResourceManager.GenerateReadWriteVersionListLength = m_GenerateReadWriteVersionListLength = value; }
        }
        ...
        {
            get { return m_ResourceManager.ApplyingResourcePackPath; }
        }
        ...
        {
            get { return m_ResourceManager.ApplyWaitingCount; }
        }
        ...
        {
            get { return m_ResourceManager.UpdateRetryCount; }
            set { m_ResourceManager.UpdateRetryCount = m_UpdateRetryCount = value; }
        }
        ...
        {
            get { return m_ResourceManager.UpdatingResourceGroup; }
        }
        ...
        {
            get { return m_ResourceManager.UpdateWaitingCount; }
        }
        ...
        {
            get { return m_ResourceManager.UpdateWaitingWhilePlayingCount; }
        }
        ...
        {
            get { return m_ResourceManager.UpdateCandidateCount; }
        }
        ...
        {
            get { return m_ResourceManager.LoadTotalAgentCount; }
        }
        ...
        {
            get { return m_ResourceManager.LoadFreeAgentCount; }
        }
        ...
        {
            get { return m_ResourceManager.LoadWorkingAgentCount; }
        }
        ...
        {
            get { return m_ResourceManager.LoadWaitingTaskCount; }
        }
        ...
        {
            get { return m_ResourceManager.ResourceAutoReleaseInterval; }
            set { m_ResourceManager.ResourceAutoReleaseInterval = m_ResourceAutoReleaseInterval = value; }
        }
        ...
        {
            get { return m_ResourceManager.ResourceCapacity; }
            set { m_ResourceManager.ResourceCapacity = m_ResourceCapacity = value; }
        }
        ...
        {
            get { return m_ResourceManager.ResourceExpireTime; }
            set { m_ResourceManager.ResourceExpireTime = m_ResourceExpireTime = value; }
        }
        ...
        {
            get { return m_ResourceManager.ResourcePriority; }
            set { m_ResourceManager.ResourcePriority = m_ResourcePriority = value; }
        }
        ...
        private void Start()
        {
            ...
            new GameFrameX.Resource.ResourceManager();
        ...
        public void SetResourceMode(ResourceMode resourceMode)
        {
            ...
            switch (resourceMode)
            {
                case ResourceMode.Package:
                    m_ResourceManager.PackageVersionListSerializer.RegisterDeserializeCallback(0,
                        BuiltinVersionListSerializer.PackageVersionListDeserializeCallback_V0);
                    m_ResourceManager.PackageVersionListSerializer.RegisterDeserializeCallback(1,
                        BuiltinVersionListSerializer.PackageVersionListDeserializeCallback_V1);
                    m_ResourceManager.PackageVersionListSerializer.RegisterDeserializeCallback(2,
                        BuiltinVersionListSerializer.PackageVersionListDeserializeCallback_V2);
                    break;

                case ResourceMode.Updatable:
                case ResourceMode.UpdatableWhilePlaying:
                    m_ResourceManager.UpdatableVersionListSerializer.RegisterDeserializeCallback(0,
                        BuiltinVersionListSerializer.UpdatableVersionListDeserializeCallback_V0);
                    m_ResourceManager.UpdatableVersionListSerializer.RegisterDeserializeCallback(1,
                        BuiltinVersionListSerializer.UpdatableVersionListDeserializeCallback_V1);
                    m_ResourceManager.UpdatableVersionListSerializer.RegisterDeserializeCallback(2,
                        BuiltinVersionListSerializer.UpdatableVersionListDeserializeCallback_V2);

                    m_ResourceManager.UpdatableVersionListSerializer.RegisterTryGetValueCallback(0,
                        BuiltinVersionListSerializer.UpdatableVersionListTryGetValueCallback_V0);
                    m_ResourceManager.UpdatableVersionListSerializer.RegisterTryGetValueCallback(1,
                        BuiltinVersionListSerializer.UpdatableVersionListTryGetValueCallback_V1_V2);
                    m_ResourceManager.UpdatableVersionListSerializer.RegisterTryGetValueCallback(2,
                        BuiltinVersionListSerializer.UpdatableVersionListTryGetValueCallback_V1_V2);

                    m_ResourceManager.ReadOnlyVersionListSerializer.RegisterDeserializeCallback(0,
                        BuiltinVersionListSerializer.LocalVersionListDeserializeCallback_V0);
                    m_ResourceManager.ReadOnlyVersionListSerializer.RegisterDeserializeCallback(1,
                        BuiltinVersionListSerializer.LocalVersionListDeserializeCallback_V1);
                    m_ResourceManager.ReadOnlyVersionListSerializer.RegisterDeserializeCallback(2,
                        BuiltinVersionListSerializer.LocalVersionListDeserializeCallback_V2);

                    m_ResourceManager.ReadWriteVersionListSerializer.RegisterSerializeCallback(0,
                        BuiltinVersionListSerializer.LocalVersionListSerializeCallback_V0);
                    m_ResourceManager.ReadWriteVersionListSerializer.RegisterSerializeCallback(1,
                        BuiltinVersionListSerializer.LocalVersionListSerializeCallback_V1);
                    m_ResourceManager.ReadWriteVersionListSerializer.RegisterSerializeCallback(2,
                        BuiltinVersionListSerializer.LocalVersionListSerializeCallback_V2);

                    m_ResourceManager.ReadWriteVersionListSerializer.RegisterDeserializeCallback(0,
                        BuiltinVersionListSerializer.LocalVersionListDeserializeCallback_V0);
                    m_ResourceManager.ReadWriteVersionListSerializer.RegisterDeserializeCallback(1,
                        BuiltinVersionListSerializer.LocalVersionListDeserializeCallback_V1);
                    m_ResourceManager.ReadWriteVersionListSerializer.RegisterDeserializeCallback(2,
                        BuiltinVersionListSerializer.LocalVersionListDeserializeCallback_V2);

                    m_ResourceManager.ResourcePackVersionListSerializer.RegisterDeserializeCallback(0,
                        BuiltinVersionListSerializer.ResourcePackVersionListDeserializeCallback_V0);
                    break;
            }
        }
        ...
        {
            m_ResourceManager.UpdateVersionList(versionListLength, versionListHashCode, versionListCompressedLength,
        ...
        {
            return m_ResourceManager.GetBinaryPath(binaryAssetName, out storageInReadOnly, out storageInFileSystem,
        ...
        private void OnResourceVerifyStart(object sender, GameFrameX.Resource.ResourceVerifyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyStartEventArgs.Create(e));
        }

        private void OnResourceVerifySuccess(object sender, GameFrameX.Resource.ResourceVerifySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifySuccessEventArgs.Create(e));
        }

        private void OnResourceVerifyFailure(object sender, GameFrameX.Resource.ResourceVerifyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyFailureEventArgs.Create(e));
        }

        private void OnResourceApplyStart(object sender, GameFrameX.Resource.ResourceApplyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyStartEventArgs.Create(e));
        }

        private void OnResourceApplySuccess(object sender, GameFrameX.Resource.ResourceApplySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplySuccessEventArgs.Create(e));
        }

        private void OnResourceApplyFailure(object sender, GameFrameX.Resource.ResourceApplyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateStart(object sender, GameFrameX.Resource.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateStartEventArgs.Create(e));
        }

        private void OnResourceUpdateChanged(object sender, GameFrameX.Resource.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateChangedEventArgs.Create(e));
        }

        private void OnResourceUpdateSuccess(object sender, GameFrameX.Resource.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateSuccessEventArgs.Create(e));
        }

        private void OnResourceUpdateFailure(object sender, GameFrameX.Resource.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateAllComplete(object sender,
            GameFrameX.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
