...
namespace GameFrameX.Runtime
{
    ...
    public sealed class ResourceUpdateAllCompleteEventArgs : GameEventArgs
    {
        ...
        /// 资源更新全部完成事件编号。
        /// </summary>
        public static readonly string EventId = typeof(ResourceUpdateAllCompleteEventArgs).FullName;
        ...
        public static ResourceUpdateAllCompleteEventArgs Create(GameFrameX.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
