...
namespace GameFrameX.Runtime
{
    ...
    public sealed class ResourceVerifySuccessEventArgs : GameEventArgs
    {
        ...
        /// 资源校验成功事件编号。
        /// </summary>
        public static readonly string EventId = typeof(ResourceVerifySuccessEventArgs).FullName;
        ...
        public static ResourceVerifySuccessEventArgs Create(GameFrameX.Resource.ResourceVerifySuccessEventArgs e)
        {
