...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class BaseComponent : GameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            Log.Info("Game Version: {0} ({1}), Unity Version: {2}", GameFramework.Version.GameVersion,
                GameFramework.Version.InternalGameVersion, Application.unityVersion);
        ...
        private void InitVersionHelper()
        {
            ...
            GameFramework.Version.IVersionHelper versionHelper =
                (GameFramework.Version.IVersionHelper) Activator.CreateInstance(versionHelperType);
