...
namespace Animancer
{
    ...
    public class SpriteRendererTextureSwap : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("The SpriteRenderer that will have its Sprite modified")]
        ...
        [SerializeField] [Tooltip("The replacement for the original Sprite texture")]
        ...
        public static bool TrySwapTexture(Dictionary<Sprite, Sprite> spriteMap, Texture2D texture, ref Sprite sprite)
        {
            ...
            if (!spriteMap.TryGetValue(sprite, out var otherSprite))
            {
                ...
                if (index >= 0)
                {
                    var newName =
                        texture.name +
                        name.Substring(index + originalTextureName.Length,
                            name.Length - (index + originalTextureName.Length));
