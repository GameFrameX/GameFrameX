...
{{cs_start_name_space_grace x.namespace_with_top_module}}
    ...
    public sealed partial class {{name}}
    {
        ...
        public {{name}}(JSONNode _json)
        {
            ...
            _dataMap = new Dictionary<{{cs_define_type key_type}}, {{cs_define_type value_type}}>(count);
            _dataList = new List<{{cs_define_type value_type}}>(count);
    ...
    {{~end~}}
        ...
        public {{cs_define_type value_type}} this[{{cs_define_type key_type}} key]
        {
