    ...
    public class AssetBundleCollectorWindow : EditorWindow
    {
        ...
        public static void ShowExample()
        {
            AssetBundleCollectorWindow window =
                GetWindow<AssetBundleCollectorWindow>("资源包收集工具", true, EditorDefine.DockedWindowTypes);
        ...
        {
            Undo.RecordObject(AssetBundleCollectorSettingData.Setting,
                "YooAsset.AssetBundleCollectorWindow AddPackage");
        ...
        private void RemovePackageBtn_clicked()
        {
            ...
            Undo.RecordObject(AssetBundleCollectorSettingData.Setting,
                "YooAsset.AssetBundleCollectorWindow RemovePackage");
        ...
        private void RemoveGroupBtn_clicked()
        {
            ...
            Undo.RecordObject(AssetBundleCollectorSettingData.Setting,
                "YooAsset.AssetBundleCollectorWindow RemoveGroup");
        ...
        private void BindCollectorListViewItem(VisualElement element, int index)
        {
            ...
            removeBtn.clicked += () => { RemoveCollectorBtn_clicked(collector); };
        ...
        private void RefreshFoldout(Foldout foldout, AssetBundleCollectorGroup group, AssetBundleCollector collector)
        {
                ...
                collector.CollectorType == ECollectorType.StaticAssetCollector)
            {
                ...
                try
                {
                    CollectCommand command = new CollectCommand(EBuildMode.DryRunBuild);
        ...
        private void AddCollectorBtn_clicked()
        {
            ...
            Undo.RecordObject(AssetBundleCollectorSettingData.Setting,
                "YooAsset.AssetBundleCollectorWindow AddCollector");
        ...
        private void RemoveCollectorBtn_clicked(AssetBundleCollector selectCollector)
        {
            ...
            Undo.RecordObject(AssetBundleCollectorSettingData.Setting,
                "YooAsset.AssetBundleCollectorWindow RemoveCollector");
