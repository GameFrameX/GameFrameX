    ...
    public class AssetBundleBuilderWindow : EditorWindow
    {
        ...
        public static void ShowExample()
        {
            AssetBundleBuilderWindow window =
                GetWindow<AssetBundleBuilderWindow>("资源包构建工具", true, EditorDefine.DockedWindowTypes);
        ...
        public void CreateGUI()
        {
            try
            {
                ...
                {
                    int defaultIndex =
                        GetDefaultEncryptionIndex(AssetBundleBuilderSettingData.Setting.EncyptionClassName);
                ...
                {
                    AssetBundleBuilderSettingData.IsDirty = true;
                    AssetBundleBuilderSettingData.Setting.OutputNameStyle =
                        (EOutputNameStyle) _outputNameStyleField.value;
                });
                ...
                _copyBuildinFileOptionField.SetValueWithoutNotify(AssetBundleBuilderSettingData.Setting
                ...
                {
                    AssetBundleBuilderSettingData.IsDirty = true;
                    AssetBundleBuilderSettingData.Setting.CopyBuildinFileOption =
                        (ECopyBuildinFileOption) _copyBuildinFileOptionField.value;
                    RefreshWindow();
                });

                // 首包文件的资源标签
                _copyBuildinFileTagsField = root.Q<TextField>("CopyBuildinFileTags");
                _copyBuildinFileTagsField.SetValueWithoutNotify(AssetBundleBuilderSettingData.Setting
                    .CopyBuildinFileTags);
                ...
                // 构建新版本号按钮
                var createBuildNumber = root.Q<Button>("CreateBuildNumber");
                createBuildNumber.clicked += CreateBuildNumberButton_clicked;
        ...
        private void RefreshWindow()
        {
            ...
            bool tagsFiledVisible = copyOption == ECopyBuildinFileOption.ClearAndCopyByTags ||
                                    copyOption == ECopyBuildinFileOption.OnlyCopyByTags;
        ...
        private void CreateBuildNumberButton_clicked()
        {
            _buildVersionField.SetValueWithoutNotify(GetBuildPackageVersion());
            SaveBtn_clicked();
        }
