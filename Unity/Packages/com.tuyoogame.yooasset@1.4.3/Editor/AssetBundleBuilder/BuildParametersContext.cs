...
namespace YooAsset.Editor
{
    public class BuildParametersContext : IContextObject
    {
        ...
        public string GetPipelineOutputDirectory()
        {
            ...
            {
                _pipelineOutputDirectory = AssetBundleBuilderHelper.MakePipelineOutputDirectory(Parameters.OutputRoot,
                    Parameters.PackageName, Parameters.BuildTarget, Parameters.BuildMode);
            }
        ...
        public string GetPackageOutputDirectory()
        {
            if (string.IsNullOrEmpty(_packageOutputDirectory))
            {
                _packageOutputDirectory =
                    $"{Parameters.OutputRoot}/{Parameters.PackageName}/{Parameters.BuildTarget}/{Parameters.PackageVersion}";
            }
        ...
        public UnityEditor.Build.Pipeline.BundleBuildParameters GetSBPBuildParameters()
        {
            ...
            var buildParams =
                new UnityEditor.Build.Pipeline.BundleBuildParameters(Parameters.BuildTarget, targetGroup,
