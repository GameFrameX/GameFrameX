...
namespace YooAsset
{
    ...
    internal class PatchManifest
    {
        ...
        /// </summary>
        [NonSerialized] public Dictionary<string, PatchBundle> BundleDic;

        /// <summary>
        /// 资源映射集合（提供AssetPath获取PatchAsset）
        /// </summary>
        [NonSerialized] public Dictionary<string, PatchAsset> AssetDic;

        /// <summary>
        /// 资源路径映射集合
        /// </summary>
        [NonSerialized] public Dictionary<string, string> AssetPathMapping;
