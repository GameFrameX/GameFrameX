...
namespace cfg.test
{
    public partial class TbCompositeJsonTable2
    {
        ...
        public TbCompositeJsonTable2(JSONNode jsonNode)
        {
            ...
            {
                test.CompositeJsonTable2 deserializeItem;
                { if(!vNode.IsObject) { throw new SerializationException(); }  deserializeItem = test.CompositeJsonTable2.DeserializeCompositeJsonTable2(vNode);  }
                _dataList.Add(deserializeItem);
                _dataMap.Add(deserializeItem.Id, deserializeItem);
            }
        }
    
        public System.Collections.Generic.Dictionary<int, test.CompositeJsonTable2> DataMap 
        {
            get { return _dataMap; }
        }

        public System.Collections.Generic.List<test.CompositeJsonTable2> DataList 
        {
