...
namespace cfg.item
{
    ...
    public sealed partial class Item :  Bright.Config.BeanBase 
    {
        ...
        public Item(int id, string name, item.EMajorType major_type, item.EMinorType minor_type, item.EItemQuality quality, string icon, string icon_backgroud, string icon_mask, string desc, int show_order, string quantifier, bool show_in_bag, int min_show_level, bool batch_usable, float progress_time_when_use, bool show_hint_when_use, bool droppable, int? price, item.EUseType use_type, int? level_up_id ) 
        {
            this.Id = id;
            this.Name = name;
