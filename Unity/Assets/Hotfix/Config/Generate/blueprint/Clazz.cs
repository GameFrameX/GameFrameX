...
namespace cfg.blueprint
{
    public abstract partial class Clazz :  Bright.Config.BeanBase 
    {
        public Clazz(JSONNode _json) 
        {
            ...
            { var __json0 = _json["parents"]; if(!__json0.IsArray) { throw new SerializationException(); } Parents = new System.Collections.Generic.List<blueprint.Clazz>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { blueprint.Clazz __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = blueprint.Clazz.DeserializeClazz(__e0);  }  Parents.Add(__v0); }   }
            { var __json0 = _json["methods"]; if(!__json0.IsArray) { throw new SerializationException(); } Methods = new System.Collections.Generic.List<blueprint.Method>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { blueprint.Method __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = blueprint.Method.DeserializeMethod(__e0);  }  Methods.Add(__v0); }   }
            PostInit();
        }
