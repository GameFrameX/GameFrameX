...
namespace cfg.test
{
    public sealed partial class MultiRowTitle :  Bright.Config.BeanBase 
    {
        public MultiRowTitle(JSONNode _json) 
        {
            ...
            { var __json0 = _json["x2"]; if(!__json0.IsArray) { throw new SerializationException(); } X2 = new System.Collections.Generic.List<test.H2>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { test.H2 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = test.H2.DeserializeH2(__e0);  }  X2.Add(__v0); }   }
            { var __json0 = _json["x3"]; if(!__json0.IsArray) { throw new SerializationException(); } int _n0 = __json0.Count; X3 = new test.H2[_n0]; int __index0=0; foreach(JSONNode __e0 in __json0.Children) { test.H2 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = test.H2.DeserializeH2(__e0);  }  X3[__index0++] = __v0; }   }
            { var __json0 = _json["x4"]; if(!__json0.IsArray) { throw new SerializationException(); } int _n0 = __json0.Count; X4 = new test.H2[_n0]; int __index0=0; foreach(JSONNode __e0 in __json0.Children) { test.H2 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = test.H2.DeserializeH2(__e0);  }  X4[__index0++] = __v0; }   }
            PostInit();
        }
