...
namespace cfg.test
{
    public sealed partial class TbTestExternalType
    {
        ...
        public TbTestExternalType(JSONNode _json)
        {
            var count = _json.Children.Count();
            _dataMap = new Dictionary<int, test.TestExternalType>(count);
            _dataList = new List<test.TestExternalType>(count);
        ...
        public test.TestExternalType GetOrDefault(int key)
        {
        ...
        public test.TestExternalType this[int key]
        {
