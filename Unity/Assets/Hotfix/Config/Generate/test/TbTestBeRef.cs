...
namespace cfg.test
{
    public sealed partial class TbTestBeRef
    {
        private readonly Dictionary<int, test.TestBeRef> _dataMap;
        private readonly List<test.TestBeRef> _dataList;
        
        public TbTestBeRef(JSONNode _json)
        {
            var count = _json.Children.Count();
            _dataMap = new Dictionary<int, test.TestBeRef>(count);
            _dataList = new List<test.TestBeRef>(count);
