...
namespace cfg.test
{
    public sealed partial class TbDefineFromExcel
    {
        ...
        public TbDefineFromExcel(JSONNode _json)
        {
            var count = _json.Children.Count();
            _dataMap = new Dictionary<int, test.DefineFromExcel>(count);
            _dataList = new List<test.DefineFromExcel>(count);
        ...
        public test.DefineFromExcel this[int key]
        {
