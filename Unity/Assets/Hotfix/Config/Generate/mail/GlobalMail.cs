...
namespace cfg.mail
{
    public sealed partial class GlobalMail :  Bright.Config.BeanBase 
    {
        public GlobalMail(JSONNode _json) 
        {
            ...
            { var __json0 = _json["server_list"]; if(!__json0.IsArray) { throw new SerializationException(); } ServerList = new System.Collections.Generic.List<int>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { int __v0;  { if(!__e0.IsNumber) { throw new SerializationException(); }  __v0 = __e0; }  ServerList.Add(__v0); }   }
