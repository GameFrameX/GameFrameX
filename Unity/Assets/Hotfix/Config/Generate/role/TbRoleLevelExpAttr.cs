...
namespace cfg.role
{
    public sealed partial class TbRoleLevelExpAttr
    {
        ...
        public TbRoleLevelExpAttr(JSONNode _json)
        {
            var count = _json.Children.Count();
            _dataMap = new Dictionary<int, role.LevelExpAttr>(count);
            _dataList = new List<role.LevelExpAttr>(count);
        ...
        public role.LevelExpAttr this[int key]
        {
