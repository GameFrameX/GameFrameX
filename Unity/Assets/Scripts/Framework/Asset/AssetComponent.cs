...
public sealed class AssetComponent : MonoBehaviour
{
    public static AssetComponent Instance { get; private set; }
    ...
    private const string BuildInPackageName = "DefaultPackage";
