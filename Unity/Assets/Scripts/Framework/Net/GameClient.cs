    ...
    public class GameClient 
    {
        ...
        public void Receive(Message msg)
        {
            receiveActor.SendAsync(() =>
            {
                ...
                GlobalEventDispatcher.NetDispatcher.DispatchEvent(msg.MsgId);
                msgQueue.Dequeue();
            });
        }
        ...
        private void OnConnected(NetCode code)
        {
            receiveActor.SendAsync(() =>
            {
                GlobalEventDispatcher.NetDispatcher.DispatchEvent(ConnectEvt, code);
            });
        }
        ...
        public void OnDisConnected()
        {
            receiveActor.SendAsync(() =>
            {
                GlobalEventDispatcher.NetDispatcher.DispatchEvent(DisconnectEvt);
            });
        }
