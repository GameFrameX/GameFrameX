...
{
    public sealed class UserInfoFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Hotfix.Proto.Proto.UserInfo>
    {
        // RoleName
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Hotfix.Proto.Proto.UserInfo value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.DateTime>(formatterResolver).Serialize(ref writer, value.CreateTime, options);
            writer.WriteRaw(GetSpan_VipLevel());
            writer.Write(value.VipLevel);
        }

        public global::Hotfix.Proto.Proto.UserInfo Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::Hotfix.Proto.Proto.UserInfo();
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 10:
                        ...
                        ____result.CreateTime = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.DateTime>(formatterResolver).Deserialize(ref reader, options);
                        continue;
