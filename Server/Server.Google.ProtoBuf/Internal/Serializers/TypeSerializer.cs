...
namespace ProtoBuf.Internal.Serializers
{
    ...
    {
        public static IProtoTypeSerializer Create(Type forType, int[] fieldNumbers, IRuntimeProtoSerializerNode[] serializers, MethodInfo[] baseCtorCallbacks, bool isRootType, bool useConstructor, bool assertKnownType, CallbackSet callbacks, Type constructType, MethodInfo factory, Type rootType,
...
#pragma warning restore CA2208 // Instantiate argument exceptions correctly
            ...
            bool hasConstructor = !constructType.IsAbstract && Helpers.GetConstructor(constructType, Type.EmptyTypes, true) != null;
        ...
        {
            get { return (ExpectedType.IsClass || ExpectedType.IsInterface) && !ExpectedType.IsSealed; }
        }
                ...
                switch (parameters.Length)
                {
                    ...
                    default:
                        ...
                        for (int i = 0; i < args.Length; i++)
                        {
                            ...
                            if (paramType == typeof(ISerializationContext))
                            {
                                val = serializationContext;
                            }
                            else if (paramType == typeof(SerializationContext))
                            {
                                val = SerializationContext.AsSerializationContext(serializationContext);
                            }
                            else if (paramType == typeof(StreamingContext))
                            {
                                val = SerializationContext.AsStreamingContext(serializationContext);
                            }
        ...
        bool IRuntimeProtoSerializerNode.RequiresOldValue
        {
            get { return true; }
        }

        bool IRuntimeProtoSerializerNode.ReturnsValue
        {
            get { return false; }
...
#pragma warning restore IDE0060
        ...
        bool IProtoTypeSerializer.ShouldEmitCreateInstance
            => factory != null || !GetFlag(StateFlags.UseConstructor);
