...
namespace Server.NetWork.TCPSocket.Base
{
    /// <summary>
    /// TCP server is used to connect, disconnect and manage TCP sessions
    /// </summary>
    /// <remarks>Thread-safe</remarks>
    public class TcpServer : BaseNetChannel, IDisposable
    {
        /// <summary>
        ...
        /// Server sessions
        /// </summary>
        protected readonly ConcurrentDictionary<string, TcpSession> Sessions = new ConcurrentDictionary<string, TcpSession>();
        ...
        public TcpSession FindSession(string id)
        {
        ...
        /// </summary>
        /// <param name="id">Session Id</param>
        internal void UnregisterSession(string id)
        {
            // Unregister session by Id
