...
namespace Server.NetWork.TCPSocket.Base
{
    ...
    public class TcpSession : IDisposable
    {
        ...
        internal void Connect(Socket socket)
        {
            ...
            // Setup buffers
            _receiveBuffer = new SocketBuffer();
            _sendBufferMain = new SocketBuffer();
            _sendBufferFlush = new SocketBuffer();
        ...
        private SocketBuffer _receiveBuffer;
        ...
        private SocketBuffer _sendBufferMain;
        private SocketBuffer _sendBufferFlush;
