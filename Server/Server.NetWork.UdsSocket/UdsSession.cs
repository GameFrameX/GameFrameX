...
namespace Server.NetWork.UdsSocket
{
    /// <summary>
    ...
    public class UdsSession : IDisposable
    {
        ...
        internal void Connect(Socket socket)
        {
            ...
            // Setup buffers
            receiveSocketBuffer = new SocketBuffer();
            sendSocketBufferMain = new SocketBuffer();
            sendSocketBufferFlush = new SocketBuffer();
            ...
            receiveSocketBuffer.Reserve(OptionReceiveBufferSize);
            sendSocketBufferMain.Reserve(OptionSendBufferSize);
            sendSocketBufferFlush.Reserve(OptionSendBufferSize);
            ...
            if (sendSocketBufferMain.IsEmpty)
                OnEmpty();
        }
        ...
        private SocketBuffer receiveSocketBuffer;
        private SocketAsyncEventArgs _receiveEventArg;
        // Send buffer
        private readonly object _sendLock = new object();
        private bool _sending;
        private SocketBuffer sendSocketBufferMain;
        private SocketBuffer sendSocketBufferFlush;
        ...
        public virtual bool SendAsync(ReadOnlySpan<byte> buffer)
        {
            ...
            lock (_sendLock)
            {
                ...
                if (((sendSocketBufferMain.Size + buffer.Length) > OptionSendBufferLimit) && (OptionSendBufferLimit > 0))
                {
                ...
                sendSocketBufferMain.Append(buffer);

                // Update statistic
                BytesPending = sendSocketBufferMain.Size;
        ...
        private void TryReceive()
        {
            ...
            while (process)
            {
                ...
                try
                {
                    ...
                    _receiving = true;
                    _receiveEventArg.SetBuffer(receiveSocketBuffer.Data, 0, (int)receiveSocketBuffer.Capacity);
        ...
        private void TrySend()
        {
            ...
            while (process)
            {
                ...
                lock (_sendLock)
                {
                    ...
                    if (sendSocketBufferFlush.IsEmpty)
                    {
                        // Swap flush and main buffers
                        sendSocketBufferFlush = Interlocked.Exchange(ref sendSocketBufferMain, sendSocketBufferFlush);
                        _sendBufferFlushOffset = 0;

                        // Update statistic
                        BytesPending = 0;
                        BytesSending += sendSocketBufferFlush.Size;
                ...
                try
                {
                    ...
                    _sendEventArg.SetBuffer(sendSocketBufferFlush.Data, (int)_sendBufferFlushOffset, (int)(sendSocketBufferFlush.Size - _sendBufferFlushOffset));
        ...
        private void ClearBuffers()
        {
            ...
            {
                // Clear send buffers
                sendSocketBufferMain.Clear();
                sendSocketBufferFlush.Clear();
                _sendBufferFlushOffset= 0;
        ...
        private bool ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            if (size > 0)
            {
                ...
                // Call the buffer received handler
                OnReceived(receiveSocketBuffer.Data, 0, size);

                // If the receive buffer is full increase its size
                if (receiveSocketBuffer.Capacity == size)
                {
                    ...
                    receiveSocketBuffer.Reserve(2 * size);
                }
            }
        ...
        private bool ProcessSend(SocketAsyncEventArgs e)
        {
            ...
            if (size > 0)
            {
                ...
                if (_sendBufferFlushOffset == sendSocketBufferFlush.Size)
                {
