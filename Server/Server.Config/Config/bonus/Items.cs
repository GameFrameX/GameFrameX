...
public sealed partial class Items :  bonus.Bonus 
{
    ...
    {
        { var __json0 = _json.GetProperty("item_list"); int _n0 = __json0.GetArrayLength(); ItemList = new bonus.Item[_n0]; int __index0=0; foreach(JsonElement __e0 in __json0.EnumerateArray()) { bonus.Item __v0;  __v0 = bonus.Item.DeserializeItem(__e0);  ItemList[__index0++] = __v0; }   }
        PostInit();
    }
