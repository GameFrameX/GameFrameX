...
public sealed partial class WeightBonus :  bonus.Bonus 
{
    ...
    {
        { var __json0 = _json.GetProperty("bonuses"); int _n0 = __json0.GetArrayLength(); Bonuses = new bonus.WeightBonusInfo[_n0]; int __index0=0; foreach(JsonElement __e0 in __json0.EnumerateArray()) { bonus.WeightBonusInfo __v0;  __v0 = bonus.WeightBonusInfo.DeserializeWeightBonusInfo(__e0);  Bonuses[__index0++] = __v0; }   }
        PostInit();
    }
