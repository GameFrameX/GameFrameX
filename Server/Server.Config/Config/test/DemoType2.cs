...
public sealed partial class DemoType2 :  BeanBase 
{
    public DemoType2(JsonElement _json) 
    {
        ...
        { var __json0 = _json.GetProperty("k2"); K2 = new System.Collections.Generic.List<int>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { int __v0;  __v0 = __e0.GetInt32();  K2.Add(__v0); }   }
        { var __json0 = _json.GetProperty("k5"); K5 = new System.Collections.Generic.HashSet<int>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { int __v0;  __v0 = __e0.GetInt32();  K5.Add(__v0); }   }
