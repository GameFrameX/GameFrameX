...
public sealed partial class MultiRowRecord :  BeanBase 
{
    public MultiRowRecord(JsonElement _json) 
    {
        ...
        { var __json0 = _json.GetProperty("one_rows"); OneRows = new System.Collections.Generic.List<test.MultiRowType1>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { test.MultiRowType1 __v0;  __v0 = test.MultiRowType1.DeserializeMultiRowType1(__e0);  OneRows.Add(__v0); }   }
        { var __json0 = _json.GetProperty("multi_rows1"); MultiRows1 = new System.Collections.Generic.List<test.MultiRowType1>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { test.MultiRowType1 __v0;  __v0 = test.MultiRowType1.DeserializeMultiRowType1(__e0);  MultiRows1.Add(__v0); }   }
        { var __json0 = _json.GetProperty("multi_rows2"); int _n0 = __json0.GetArrayLength(); MultiRows2 = new test.MultiRowType1[_n0]; int __index0=0; foreach(JsonElement __e0 in __json0.EnumerateArray()) { test.MultiRowType1 __v0;  __v0 = test.MultiRowType1.DeserializeMultiRowType1(__e0);  MultiRows2[__index0++] = __v0; }   }
        { var __json0 = _json.GetProperty("multi_rows4"); MultiRows4 = new System.Collections.Generic.Dictionary<int, test.MultiRowType2>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { int _k0;  _k0 = __e0[0].GetInt32(); test.MultiRowType2 _v0;  _v0 = test.MultiRowType2.DeserializeMultiRowType2(__e0[1]);  MultiRows4.Add(_k0, _v0); }   }
        { var __json0 = _json.GetProperty("multi_rows5"); MultiRows5 = new System.Collections.Generic.List<test.MultiRowType3>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { test.MultiRowType3 __v0;  __v0 = test.MultiRowType3.DeserializeMultiRowType3(__e0);  MultiRows5.Add(__v0); }   }
        { var __json0 = _json.GetProperty("multi_rows6"); MultiRows6 = new System.Collections.Generic.Dictionary<int, test.MultiRowType2>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { int _k0;  _k0 = __e0[0].GetInt32(); test.MultiRowType2 _v0;  _v0 = test.MultiRowType2.DeserializeMultiRowType2(__e0[1]);  MultiRows6.Add(_k0, _v0); }   }
        { var __json0 = _json.GetProperty("multi_rows7"); MultiRows7 = new System.Collections.Generic.Dictionary<int, int>(__json0.GetArrayLength()); foreach(JsonElement __e0 in __json0.EnumerateArray()) { int _k0;  _k0 = __e0[0].GetInt32(); int _v0;  _v0 = __e0[1].GetInt32();  MultiRows7.Add(_k0, _v0); }   }
        PostInit();
    }
