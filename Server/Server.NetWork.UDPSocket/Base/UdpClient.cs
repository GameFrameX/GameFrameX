...
namespace Server.NetWork.UDPSocket.Base
{
    ...
    public class UdpClient : IDisposable
    {
        ...
        public virtual bool Connect()
        {
            ...
            sendSocketBuffer = new SocketBuffer();
        ...
        public virtual bool SendAsync(EndPoint endpoint, ReadOnlySpan<byte> buffer)
        {
            ...
            if (((sendSocketBuffer.Size + buffer.Length) > OptionSendBufferLimit) && (OptionSendBufferLimit > 0))
            {
            ...
            sendSocketBuffer.Append(buffer);

            // Update statistic
            BytesSending = sendSocketBuffer.Size;
        ...
        private void TrySend()
        {
            ...
            try
            {
                ...
                _sendEventArg.SetBuffer(sendSocketBuffer.Data, 0, (int)(sendSocketBuffer.Size));
        ...
        private void ProcessReceiveFrom(SocketAsyncEventArgs e)
        {
            ...
            // Call the datagram received handler
            OnReceived(e.RemoteEndPoint, receiveSocketBuffer.Data, 0, size);
