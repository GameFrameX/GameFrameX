...
{
    public sealed class UdpChannel : BaseNetChannel
    {
        ...
        public UdpChannel(ConnectionContext context, IMessageHelper messageHandler, Action<MessageObject> onMessage = null) : base(messageHandler)
        {
